...
<div class="container">
  ...
  <div class="col-md-12">
    <form id="form-data" method="post" action="{{ route('invoice.store') }}">
     @csrf
      ...
      <table class="table table-bordered table-hover" id="tab_logic">     
        ...
        <tbody>
          <tr id='addr0'>
            ...
            <td><input type="number" name='price[]' id="" value="{{old('price[]')}}"  placeholder='Enter Unit Price' class="form-control price" step="0.01" min="0"/></td>
      ...
      <table class="table table-bordered table-hover" id="tab_logic_total">
        <tbody>
         ...
         <div class="form-check form-check-inline">
                ...
                <br>
    <input type="submit" id="" class="btn btn-default my-4 pull-right"></button>
    <a class="btn btn-default my-4" href="{{ route( 'downloadInvoice' , App\Invoice::latest()->first()->id) }}">Download Last Invoice</a>
      </div> 
   </div>
  </div>
  </form>
